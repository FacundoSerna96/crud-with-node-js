...
--
-- Servidor: localhost
-- Tiempo de generación: 17-01-2022 a las 18:53:03
...
CREATE TABLE `customers` (
  ...
  `salesRepEmployeeNumber` int(11) DEFAULT 1002,
...
(509, 'Motor Mint Distributors Inc.', '', '', '1607772', '', '', 'Philadelphia', '', '', 'USA', 1002, '0.00');
...
--
ALTER TABLE `customers`
  MODIFY `customerNumber` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=516;
COMMIT;
